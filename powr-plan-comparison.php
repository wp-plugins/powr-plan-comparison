<?php
    ...
    Description: Easily compare plans, products, features, and more!  Add the widget to your theme, or create a Plan Comparison on ANY page or post by using the shortcode [powr-plan-comparison]. Then, simply visit your site and click the settings icon to customize your Plan Comparison right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
