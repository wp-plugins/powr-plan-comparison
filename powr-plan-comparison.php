<?php
    ...
    Description: The easy way to compare plans, products, features, and more. Add the widget to your theme, or create a Plan Comparison on ANY page or post by using the shortcode [powr-plan-comparison]. Then, simply visit your site and click the settings icon to customize your Plan Comparison right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.0
    ...
    */
    ...
    class Powr_Plan_Comparison extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Plan Comparison.
        </p>
        <p>
